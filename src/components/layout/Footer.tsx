...
const socialLinks = [
  ...
  { icon: MessageCircle, label: 'WhatsApp', href: 'https://wa.me/919611604319', external: true },
  ...
  return (
    <footer className="border-t-4 border-[#B8893E] bg-[#1B2A4A] text-[#F6F1E4]">
      ...
      <div className="container-page grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-[1.35fr_.8fr_1fr_1fr] lg:gap-12">
        ...
        <div><h3 className="font-mono text-[10px] font-bold uppercase tracking-[.12em] text-[#d7c090]">Contact</h3><ul className="mt-5 space-y-4 text-sm text-[#F6F1E4]/70"><li className="flex gap-3"><MapPin className="mt-0.5 shrink-0 text-[#d7c090]" size={17} />Whitefield, Bengaluru, Karnataka</li><li><a href="tel:+919611604319" className="flex gap-3 hover:text-[#d7c090]"><Phone className="shrink-0 text-[#d7c090]" size={17} />+91 96116 04319</a></li><li><a href="mailto:info@edusphere.school" className="flex gap-3 hover:text-[#d7c090]"><Mail className="shrink-0 text-[#d7c090]" size={17} />info@edusphere.school</a></li></ul></div>
      </div>
