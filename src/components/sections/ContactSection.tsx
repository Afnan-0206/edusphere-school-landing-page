    ...
    <section id="contact" className="section-space bg-[#efe7d4]">
      <div className="container-page">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_.9fr]">
          ...
          <aside className="relative border border-[#1B2A4A] bg-[#1B2A4A] p-7 text-[#F6F1E4] sm:p-9"><span className="stamp absolute -right-3 -top-3 size-16 border-[#B8893E] text-center text-[8px] leading-3 text-[#B8893E]">Reply<br />promptly</span><p className="font-mono text-[10px] font-bold uppercase tracking-[.12em] text-[#d7c090]">Quick connect</p><h3 className="mt-4 font-display text-3xl font-bold leading-tight">Ready to take the first step?</h3><p className="mt-4 text-sm leading-7 text-[#F6F1E4]/75">Choose the way that feels easiest. We’ll make sure the conversation is useful, warm, and clear.</p><div className="mt-8 grid gap-3"><a href="tel:+919611604319" className="focus-ring inline-flex min-h-11 items-center justify-center gap-2 border border-[#B8893E] bg-[#B8893E] px-4 py-3 font-mono text-xs font-bold uppercase tracking-[.08em] text-[#1B2A4A] hover:bg-[#c7974c]"><Phone size={15} />Call now</a><a href="https://wa.me/919611604319" target="_blank" rel="noreferrer" className="focus-ring inline-flex min-h-11 items-center justify-center gap-2 border border-[#F6F1E4]/35 px-4 py-3 font-mono text-xs font-bold uppercase tracking-[.08em] text-[#F6F1E4] hover:bg-[#F6F1E4]/10"><MessageCircle size={15} />WhatsApp</a><a href="https://maps.app.goo.gl/SRASrUXLmWkJYKNB9" target="_blank" rel="noreferrer" className="focus-ring inline-flex min-h-11 items-center justify-center gap-2 border border-[#F6F1E4]/35 px-4 py-3 font-mono text-xs font-bold uppercase tracking-[.08em] text-[#F6F1E4] hover:bg-[#F6F1E4]/10"><Navigation size={15} />Get directions</a></div></aside>
        </div>
      </div>
    </section>
  )
